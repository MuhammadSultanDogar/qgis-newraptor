...
/***************************************************************************
 ...
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
        ...
        begin                : 2024-03-16
        git sha              : $Format:%H$
        copyright            : (C) 2024 by sultan
        email                : sultandogar2003@gmail.com
 ***************************************************************************/
...
class NewRaptor:
    ...
    def run(self):
        ...
        # if not "BUOWL Habitat" in map_layers:
        ...
        #     missing_layers.append("BAEA Buffer")
        if missing_layers:
        ...
        if result:
            ...
            QMessageBox.information(self.dlg, "Message", "New Nest ID: {}\n\nLatitude: {}\nLongitude: {}\nSpecies: {}\nBuffer: {}\nStatus: {}\nLast Survery: {}".format(valNestID, valLat, valLng, valSpecies, valBuffer, valStatus, valLast))
